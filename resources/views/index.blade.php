@extends('layout')
@section('title',"Palm Arabia Home")
@section('content')
    ...
    <!-- Banner-area-start -->
     <section class="bd-banner__area grey-bg banner__overlay banner__height-1 p-relative">
        <div class="bd-banner__image-1">
           <img src="{{url('public/assets/img/banner/banner-1.jpg')}}" alt="banner-img">
        </div>
        <div class="bd-banner__line">
           <img src="{{url('public/assets/img/banner/banner-line.png')}}" alt="banner-line">
        </div>
        <div class="container">
                       ...
                       <div class="col-xxl-6">
                          <div class="bd-banner__content__wrap">
                             <div class="bd-banner__content">
                                <p>Palm Arabia is one of the leading importer and wholesaler of Food products
                                 based in State of Qatar. We are located in Doha, which has become a global and
                                 strategic hub for commerce.</p>
                       ...
                       <div class="swiper-wrapper">
                          <div class="swiper-slide">
                             <div class="bd-banner__image-2">
                                <img src="{{url('public/assets/img/banner/slider/slider-01.jpg')}}" alt="banner-img">
                             </div>
                          </div>
                          <div class="swiper-slide">
                             <div class="bd-banner__image-2">
                                <img src="{{url('public/assets/img/banner/slider/slider-02.jpg')}}" alt="banner-img">
                             </div>
                          </div>
                          <div class="swiper-slide">
                             <div class="bd-banner__image-2">
                                <img src="{{url('public/assets/img/banner/slider/slider-03.jpg')}}" alt="banner-img">
                             </div>
                          </div>
                       </div>
                    </div>
              ...
              <div class="col-xl-6 col-lg-7 col-md-8">
                 <div class="bd-section__title-wrapper p-relative mb-85">
                    <div class="bd-section__img w-img">
                       <img src="{{url('public/assets/img/step/title-img.png')}}" alt="title-img">
                    </div>
              ...
              <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8">
                 <div class="bd-step__item text-center p-relative mb-60">
                    <div class="bd-step__arrow">
                       <img src="{{url('public/assets/img/step/step-arrow-1.png')}}" alt="step-arrow">
                    </div>
                    <div class="bd-step__icon">
                       <img src="{{url('public/assets/img/step/step-1.png')}}" alt="step-icon">
                    </div>
                    <div class="bd-step__content">
                       <h3><a href="{{url('about')}}">100% Natural</a></h3>
                       <p>We provide Natural foods that do not contain any food additives such as sweeteners, food colors, preservatives, or flavorings.</p>
                    </div>
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8">
                 <div class="bd-step__item text-center p-relative mb-60">
                    <div class="bd-step__arrow">
                       <img src="{{url('public/assets/img/step/step-arrow-2.png')}}" alt="step-arrow">
                    </div>
                    <div class="bd-step__icon">
                       <img src="{{url('public/assets/img/step/step-2.png')}}" alt="step-icon">
                    </div>
                    <div class="bd-step__content">
                       <h3><a href="{{url('about')}}">Always Fresh</a></h3>
                       <p>We ensure the freshness and safety of our proucts before pakaging</p>
                    </div>
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-8 col-sm-8">
                 <div class="bd-step__item text-center p-relative mb-60">
                  {{--   <div class="bd-step__arrow">
                    ...
                    <div class="bd-step__icon">
                       <img src="{{url('public/assets/img/step/step-3.png')}}" alt="step-icon">
                    </div>
                    <div class="bd-step__content">
                       <h3><a href="{{url('about')}}">Quality Assure</a></h3>
                       <p>We provide on the Highest quality of unrefined, minimally processed proucts</p>
                    </div>
                 </div>
              </div>
           </div>
    ...
    <section class="bd-about__area grey-bg p-relative z-index-1 pt-130 pb-70">
        <div class="container">
           <div class="bd-about__bg-wrapper p-relative">
              <img class="bd-about__bg-shape " src="{{url('public/assets/img/about/about-big-shape.png')}}" alt="about-big-shape">
           </div>
                    ...
                    <div class="bd-about__content">
                       <div class="bd-about__features">
                          <div class="bd-adbout__icon">
                             <img src="{{url('public/assets/img/about/about-icon.png')}}" alt="about-icon">
                          </div>
                       ...
                       <div class="bd-about__action">
                          <a class="bd-bn__btn-1" href="{{url('about')}}">About Us</a>
                       </div>
                    </div>
                 </div>
              </div>
              <div class="col-xl-6 col-lg-6">
                 <div class="bd-about__thumb-wrapper p-relative mb-60 ">
                    <div class="bd-about__thumb-1 w-img">
                       <img src="{{url('public/assets/img/about/about-img-1.jpg')}}" alt="about-img">
                    </div>
                    <div class="bd-about__thumb-2">
                       <img src="{{url('public/assets/img/about/about-img-2.jpg')}}" alt="about-img">
                    </div>
                    ...
                    <div class="bd-about__shape-1">
                       <img src="{{url('public/assets/img/about/about-shape-1.png')}}" alt="about-shape">
                    </div>
                                   ...
                                   <div class="swiper-wrapper">
                                         ...
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-01.png')}}" alt="product-img"></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-11.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-06.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-04.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                   ...
                                   <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-02.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-08.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-09.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                   ...
                                   <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-05.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-07.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-03.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                   ...
                                   <div class="swiper-wrapper">
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-10.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-12.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-13.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                   ...
                                   <div class="swiper-wrapper">
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-14.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
                                      ...
                                      <div class="swiper-slide">
                                         <div class="bd-product__item text-center p-relative mb-30">
                                            <div class="bd-product__thumb w-img">
                                               <a href="product-details.html"><img
                                                     src="{{url('public/assets/img/product/product-15.png')}}" alt="product-img"></a>
                                               <div class="bd-product__action">
                                                  <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                     data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                                        class="fal fa-cart-arrow-down"></i></a>
           ...
           <div class="row g-0 align-items-center">
                 ...
                 <div class="bd-choose__wrapper choose-wrapper__left mb-60">
                    <div class="bd-choose__item">
                       <div class="bd-choose__content text-end">
                          <h4>100% Organic</h4>
                          <p>No harmful Sweeteners, food colors, preservatives, or flavorings</p>
                       </div>
                       <div class="bd-choose__icon choose-icon__left">
                          <img src="{{url('public/assets/img/why-choose/why-choose-01.png')}}" alt="why-choose-img">
                       </div>
                    </div>
                    <div class="bd-choose__item">
                       <div class="bd-choose__content text-end">
                       ...
                       <div class="bd-choose__icon choose-icon__left">
                          <img src="{{url('public/assets/img/why-choose/why-choose-02.png')}}" alt="why-choose-img">
                       </div>
                    </div>
                    <div class="bd-choose__item">
                       <div class="bd-choose__content text-end">
                          <h4>No Preservation</h4>
                          <p>We value the health of customer as our top priority</p>
                       </div>
                       <div class="bd-choose__icon choose-icon__left">
                          <img src="{{url('public/assets/img/why-choose/why-choose-03.png')}}" alt="why-choose-img">
                       </div>
                    </div>
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-6">
                 <div class="bd-choose__thumb text-center w-img mb-30">
                    <img src="{{url('public/assets/img/why-choose/why-choose-big.png')}}" alt="choose-big">
                 </div>
              </div>
              <div class="col-xl-4 col-lg-4 col-md-6">
                 <div class="bd-choose__wrapper choose-wrapper__right mb-60">
                    <div class="bd-choose__item">
                       <div class="bd-choose__icon choose__icon-right">
                          <img src="{{url('public/assets/img/why-choose/why-choose-04.png')}}" alt="why-choose-img">
                       </div>
                       <div class="bd-choose__content text-start">
                          <h4>Export Quality</h4>
                          <p>We provide on the Highest quality of proucts</p>
                       </div>
                    </div>
                    <div class="bd-choose__item">
                       <div class="bd-choose__icon choose__icon-right">
                          <img src="{{url('public/assets/img/why-choose/why-choose-05.png')}}" alt="why-choose-img">
                       </div>
                       <div class="bd-choose__content text-start">
                          <h4>Totally Hygenic</h4>
                          <p>We take the necessary measures to ensure the safety of our Product.</p>
                       </div>
                    </div>
                    <div class="bd-choose__item">
                       <div class="bd-choose__icon choose__icon-right">
                          <img src="{{url('public/assets/img/why-choose/why-choose-06.png')}}" alt="why-choose-img">
                       </div>
                       <div class="bd-choose__content text-start">
                          <h4>Fast Delivery</h4>
                          <p>Excellent customer service involves meeting and surpassing expectations.</p>
                       </div>
                    </div>
                 </div>
              </div>
        ...
        <div class="container">
           ...
           <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-6">
                 <div class="bd-news__item mb-60">
                    <div class="bd-news__thumb w-img">
                       <a href="news-details.html"><img src="{{url('public/assets/img/news/news-thumb-01.jpg')}}" alt="news-image"></a>
                    </div>
              ...
              <div class="col-xl-4 col-lg-4 col-md-6">
                 <div class="bd-news__item mb-60">
                    <div class="bd-news__thumb w-img">
                       <a href="news-details.html"><img src="{{url('public/assets/img/news/news-thumb-02.jpg')}}" alt="news-image"></a>
                    </div>
                    <div class="bd-news__content">
                       <div class="bd-news__meta-list">
                          <div class="bd-news__meta-item">
              ...
              <div class="col-xl-4 col-lg-4 col-md-6">
                 <div class="bd-news__item mb-60">
                    <div class="bd-news__thumb w-img">
                       <a href="news-details.html"><img src="{{url('public/assets/img/news/news-thumb-03.jpg')}}" alt="news-image"></a>
                    </div>
                    <div class="bd-news__content">
                       <div class="bd-news__meta-list">
                          <div class="bd-news__meta-item">
