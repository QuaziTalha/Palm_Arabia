@extends('layout')
@section('title', 'Palm Arabia Products')
@section('content')
       ...
       <div class="row">
          <div class="col-xl-12">
             <div class="bd-page__banner-content text-center">
                <h2>Our Products</h2>
                <span><a href="{{route('/')}}">Home </a>- Products</span>
             </div>
          </div>
       </div>
    </div>
                            ...
                            <div class="bd-product__check">
                               <ul>
                                  <li>
                                     ...
                                     <label class="check-label" for="s-01">Meat & Fish</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-02">
                                     <label class="check-label" for="s-02">English (6)</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-03">
                                     <label class="check-label" for="s-03">Beverage Food</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-04">
                                     <label class="check-label" for="s-04">Grocery</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-05">
                                     <label class="check-label" for="s-05">Bread & Bakery</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-06">
                                     <label class="check-label" for="s-06">Frozen Foods</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-07">
                                     <label class="check-label" for="s-07">Frozen Foods</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-08">
                                     <label class="check-label" for="s-08">Fruits</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-09">
                                     <label class="check-label" for="s-09">Breakfast & Dairy</label>
                                  </li>
                                  <li>
                                     <input class="check-input" type="checkbox" id="s-10">
                                     <label class="check-label" for="s-10">Vegetable</label>
                                  </li>
                               </ul>
                            </div>
                         </div>
                            ...
                            <a href="product-details.html">
                               <div class="bd-flash___banner-item p-relative">
                                  <div class="bd-flash__banner-thumb w-img">
                                     <img src="{{url('public/assets/img/trending/flash/flash-banner-03.jpg')}}" alt="flash-banner">
                                  </div>
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="bd-trending__item text-center mb-30">
                                           <div class="bd-trending__product-thumb border-5">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-01.png')}}"
                                                    alt="product-img"></a>
                                           ...
                                           <div class="bd-trending__content">
                                              <h4 class="bd-product__title"><a href="product-details.html">Kach Kogozi
                                                    Labu</a></h4>
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-02.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                           ...
                                           <div class="bd-trending__content">
                                              <h4 class="bd-product__title"><a href="product-details.html">Organic
                                                    Banna</a></h4>
                                              <div class="bd-product__price">
                                                 <span class="bd-product__old-price"><del>$24.00</del></span><span
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-03.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__tag">
                                           ...
                                           <div class="bd-trending__content">
                                              <h4 class="bd-product__title"><a href="product-details.html">Hisma Green
                                                    Tea</a></h4>
                                              <div class="bd-product__price">
                                                 <span class="bd-product__old-price"><del>$28.00</del></span><span
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-04.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__tag">
                                           ...
                                           <div class="bd-trending__content">
                                              ...
                                              <div class="bd-product__price">
                                                 <span class="bd-product__old-price"><del>$16.00</del></span><span
                                                    class="bd-product__new-price">$8.00</span>
                                              </div>
                                              <div class="bd-product__icon">
                                                 <i class="fa-solid fa-star"></i>
                                                 <i class="fa-solid fa-star"></i>
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-05.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__tag">
                                                 <span class="tag-text danger-bg">New</span>
                                              </div>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-06.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/product/product-07.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__tag">
                                                 <span class="tag-text theme-bg">50%</span>
                                              </div>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/fruits/fruits-16.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/fruits/fruits-15.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/fruits/fruits-14.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/fruits/fruits-09.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                     ...
                                     <div class="col-xxl-3 col-xl-4 col-lg-6 col-md-6 col-sm-6">
                                        <div class="bd-trending__item mb-45 text-center">
                                           <div class="bd-trending__product-thumb">
                                              <a href="product-details.html"><img
                                                    src="{{url('public/assets/img/trending/fruits/fruits-10.png')}}"
                                                    alt="product-img"></a>
                                              <div class="bd-product__action">
                                                 <a class="cart-btn" href="javascript:void(0)" data-toggle="tooltip"
                                                    data-placement="top" title="Quick View" data-bs-toggle="modal"><i
                                        ...
                                        <div class="row align-items-center">
                                           <div class="col-xxl-4 col-lg-6 col-md-6">
                                              <div class="bd-trending__item">
                                                 <div class="bd-trending__product-thumb text-center">
                                                    <a href="product-details.html"><img
                                                          src="{{url('public/assets/img/trending/fruits/fruits-07.png')}}"
                                                          alt="product-img"></a>
                                                 </div>
                                              </div>
                                           </div>
                                        ...
                                        <div class="row align-items-center">
                                           <div class="col-xxl-4 col-lg-6 col-md-6">
                                              <div class="bd-trending__item">
                                                 <div class="bd-trending__product-thumb text-center">
                                                    <a href="product-details.html"><img
                                                          src="{{url('public/assets/img/trending/fruits/fruits-08.png')}}"
                                                          alt="product-img"></a>
                                                 </div>
                                              </div>
                                           </div>
                                        ...
                                        <div class="row align-items-center">
                                           <div class="col-xxl-4 col-lg-6 col-md-6">
                                              <div class="bd-trending__item">
                                                 <div class="bd-trending__product-thumb text-center">
                                                    <a href="product-details.html"><img
                                                          src="{{url('public/assets/img/trending/fruits/fruits-02.png')}}"
                                                          alt="product-img"></a>
                                                 </div>
                                              </div>
                                           </div>
                                        ...
                                        <div class="row align-items-center">
                                           <div class="col-xxl-4 col-lg-6 col-md-6">
                                              <div class="bd-trending__item">
                                                 <div class="bd-trending__product-thumb text-center">
                                                    <a href="product-details.html"><img
                                                          src="{{url('public/assets/img/trending/fruits/fruits-04.png')}}"
                                                          alt="product-img"></a>
                                                 </div>
                                              </div>
                                           </div>
